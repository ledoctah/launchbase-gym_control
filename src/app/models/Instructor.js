...
module.exports = {
    all(callback) {
        db.query(`SELECT instructors.*, COUNT(members) AS total_students 
            ...
            ORDER BY total_students DESC`, null, function(err, results) {
    ...
    create(data, callback) {
        ...
        const query = `INSERT INTO instructors(name,avatar_url,gender,services,birth,created_at) VALUES ($1, $2, $3, $4, $5, $6) RETURNING id`
